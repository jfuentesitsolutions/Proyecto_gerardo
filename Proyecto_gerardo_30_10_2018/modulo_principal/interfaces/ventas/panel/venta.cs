...
namespace interfaces.ventas.panel
{
...

    {
        ...
        DataTable formas_pagos;
        DataTable tipo_factura;
        DataTable cliente;
        DataTable vendedor;
        ...
        {
            relog.Start();
            formas_pagos = conexiones_BD.clases.formas_pago.datosTabla();
            tipo_factura = conexiones_BD.clases.tipos_factura.datosTabla();
            cliente = conexiones_BD.clases.clientes.datosTabla();
            vendedor = conexiones_BD.clases.usuarios.datosTabla();
            cargaListas();
