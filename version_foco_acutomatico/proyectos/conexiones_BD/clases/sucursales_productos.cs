...
namespace conexiones_BD.clases
{
    ...
    {
        string idsucursal_producto, idsucursal, idproducto, idutilidadMayoreo, idutilidadDetalles, idestante, existencias, precio_ventaD, precio_compraD, precio_ventaM, precio_compraM;
        ...
        public sucursales_productos(string idsucursal_producto, string idsucursal, string idproducto, string idutilidadMayoreo, string idutilidadDetalle, string idestante, string existencias, string precio_ventaD, string precio_compraD, string precio_ventaM, string precio_compraM)
        {
        ...
        public sucursales_productos(string idsucursal, string idproducto, string idutilidadMayoreo, string idutilidadDetalle, string idestante, string existencias, string precio_ventaD, string precio_compraD, string precio_ventaM, string precio_compraM)
        {
            this.idsucursal = idsucursal;
            this.Idproducto = idproducto;
            this.idutilidadMayoreo = idutilidadMayoreo;
        ...
        public StringBuilder sentenciaModi()
        {
            ...
            sentencia.Append("UPDATE sucursales_productos SET idsucursal='"+idsucursal+"', idproducto='"+idproducto+"', idutilidadMayoreo='"+idutilidadMayoreo+"', idutilidadDetalles='"+idutilidadDetalles+"', idestante='"+idestante+"', existencias='"+existencias+"', precio_venta='"+precio_ventaD+"', precio_compra='"+precio_compraD+"', precio_ventaM='"+precio_ventaM+"', precio_compraM='"+precio_compraM+"' WHERE idsucursal_producto='"+idsucursal_producto+"';");
            return sentencia;
        }
        ...
        public StringBuilder modificarProducto()
        {
            StringBuilder sentencia = new StringBuilder();
