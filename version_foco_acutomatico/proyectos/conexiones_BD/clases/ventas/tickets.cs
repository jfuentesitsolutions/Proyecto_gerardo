...
namespace conexiones_BD.clases.ventas
{
    public class tickets:ventas
    {
        ...
        public static DataTable datosTabla(string fecha)
        {
            DataTable Datos = new DataTable();
            String Consulta;
            Consulta = @"select vt.idventa_ticket, vt.correlativo, vt.fecha, concat(c.nombre_cliente,' ',c.apellidos_cliente) as nombre
from ventas v, ventas_tickets vt, clientes c
where v.idventa_ticket=vt.idventa_ticket and vt.idcliente=c.idcliente
and v.anulacion=1 and v.fecha>='"+fecha+" 00:00:00' and v.fecha<='"+fecha+@" 23:60:00'
