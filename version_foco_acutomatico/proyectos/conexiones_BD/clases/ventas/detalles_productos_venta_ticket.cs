...
namespace conexiones_BD.clases.ventas
{
    public class detalles_productos_venta_ticket:entidad
    {
        ...
        public static DataTable detalle_proTic(string id)
        {
            ...
            String Consulta;
            Consulta = @"select dvt.cantidad_paquete, p.nombre_presentacion, pr.nom_producto,  pp.precio, dvt.total, vt.fecha, vt.correlativo, vt.monto_total_neto, vt.efectivo, vt.cambio, ci.contenido, concat(cll.nombre_cliente,' ',cll.apellidos_cliente) as nombre,
cll.direccion, corr.inicio, corr.final, vt.idcorrelativo, pr.cod_producto
