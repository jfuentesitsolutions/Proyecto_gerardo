...
namespace conexiones_BD.clases.ventas
{
    public class correlativos_tickets:entidad
    {
        string idcorrelativo_ticket, idsucursal, inicio, final, numero_siguiente, 
            fecha_ultimo, descripcion;

        public correlativos_tickets(string idcorrelativo_ticket, string idsucursal, string inicio, string final, string numero_siguiente, string fecha_ultimo, string descripcion)
        {
